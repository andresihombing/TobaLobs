...
class SetJadwalPagi extends Component {
  ...
  componentDidMount = async() => {        
    ...
    const date = await AsyncStorage.getItem(`pagi${tambakId}`);  
  ...
  handleDatePicked = date => {    
    ...
    AsyncStorage.setItem(`pagi${tambakId}`, JSON.stringify(this.state.notificationTime));
    this.scheduleNotif()
    Alert.alert(
      '',
  ...
  scheduleNotif = async(soundName) =>{            
    PushNotification.localNotificationSchedule({
      ...
      id: `1${this.state.tambakId}`, // (optional) Valid unique 32 bit integer specified as string. default: Autogenerated Unique ID
      type: 'pagi',
  ...
  render() {
    ...
    return (
      <View style={styles.container}>        
        <Text style={styles.text}>Jadwal Pakan Pagi</Text>
