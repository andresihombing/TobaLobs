...
export default class PushJadwal extends Component {
  ...
  alert = async() => {        
    ...
    if(datePagi == "07.00" && dateSore == "17.00"){
      Alert.alert(
        ``,
  ...
  render() {        
    return (
      <SafeAreaView style={styles.container}>                      
        ...
        />  
        <ListItem
          title="Atur Jadwal Pakan Default"
          bottomDivider
          titleStyle={styles.titleStyle}
          onPress = {() => this.alert()}        
        />        
